 ...
 */
package com.example.registeration.models;
...
public class CourseRepository {
    ...
    public static void init() {
        Scanner sc = null;
        sc = new Scanner(Objects.requireNonNull(CourseRepository.class.getClassLoader().getResourceAsStream(DATA_FILE)), StandardCharsets.UTF_8);
